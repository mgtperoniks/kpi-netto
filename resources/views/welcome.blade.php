        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-emerald-50: oklch(.984 .014 180.72);
                    --color-emerald-100: oklch(.953 .051 180.801);
                    --color-emerald-200: oklch(.91 .096 180.426);
                    --color-emerald-300: oklch(.855 .138 181.071);
                    --color-emerald-400: oklch(.777 .152 181.912);
                    --color-emerald-500: oklch(.704 .14 182.503);
                    --color-emerald-600: oklch(.6 .118 184.704);
                    --color-emerald-700: oklch(.511 .096 186.391);
                    --color-emerald-800: oklch(.437 .078 188.216);
                    --color-emerald-900: oklch(.386 .063 188.416);
                    --color-emerald-950: oklch(.277 .046 192.524);
                    ...
                    --color-emerald-50: oklch(.97 .014 254.604);
                    --color-emerald-100: oklch(.932 .032 255.585);
                    --color-emerald-200: oklch(.882 .059 254.128);
                    --color-emerald-300: oklch(.809 .105 251.813);
                    --color-emerald-400: oklch(.707 .165 254.624);
                    --color-emerald-500: oklch(.623 .214 259.815);
                    --color-emerald-600: oklch(.546 .245 262.881);
                    --color-emerald-700: oklch(.488 .243 264.376);
                    --color-emerald-800: oklch(.424 .199 265.638);
                    --color-emerald-900: oklch(.379 .146 265.522);
                    --color-emerald-950: oklch(.282 .091 267.935);
